...
const loadLaunchesListStart = state => updateObject(state, {
  isError: false,
  isLoading: true,
  isNotFound: false,
  launchesList: [],
...
const loadLaunchesListSuccess = (state, { launchesList }) => updateObject(state, {
  launchesList,
  isError: false,
  isLoading: false,
...
const loadLaunchesListFail = state => updateObject(state, {
  isError: true,
  isLoading: false,
  isNotFound: false,
  launchesList: [],
